...
#ifdef _DEBUG
     cwout << "PlayerController_Sample::OnTriggerEnter: " << other->GetOwner()->GetName() << std::endl;
#endif // !__DEBUG
...
{
	#ifdef _DEBUG
	cwout << "PlayerController_Sample::OnTriggerStay: " << other->GetOwner()->GetName() << std::endl;
#endif // !__DEBUG
}
...
{
	#ifdef _DEBUG
	cwout << "PlayerController_Sample::OnTriggerExit: " << other->GetOwner()->GetName() << std::endl;
#endif // !__DEBUG
}
